/* $Revision: 1.1.1.1 $ $Id: xipe1.c,v 1.1.1.1 2007/09/14 22:49:31 linsalrob Exp $ $Date: 2007/09/14 22:49:31 $*/
#include<stdio.h>
#include<stdlib.h>
