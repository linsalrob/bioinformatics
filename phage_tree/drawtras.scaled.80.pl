...
# modified so that the image is 80kb wide, and anything longer is cut into two lines.
# to change the width of the image, just change this variable, $longestgenome

my $longestgenome = 80000;
...
print STDERR "\nAdding $genome: ", int($$genomelength{$genome}/1000), " kb ";
	my $origin;
